"""
Model inference. Can be called from command line. Takes RGB and depth input, saves
...
parser.add_argument(
    "--rgb", type=str, default="demo/test-image.color.png", help="Path to RGB image"
)
parser.add_argument(
    "--depth", type=str, default="demo/test-image.depth.png", help="Path to depth image"
)
parser.add_argument(
    "--weights",
    type=str,
    default="weights/default_weights.pt",
    help="Path to model weights",
)
parser.add_argument(
    "--output", type=str, default="results.png", help="Path to output png file"
)
parser.add_argument(
    "--device", type=str, default="cuda", choices=["cpu", "cuda", "cuda:0", "cuda:1"]
)
...
color, depth = data_transform(color_pil, depth_pil)
